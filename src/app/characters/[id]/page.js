        ...
        <div className="px-4 py-4">
          ...
          <ul>
            ...
            {character.birth_year && character.birth_year !== "n/a" && (
              <li className="mb-2">Año de nacimiento: {character.birth_year}</li>
            )}
            {character.hair_color && character.hair_color !== "n/a" && (
              <li className="mb-2">Color de pelo: {character.hair_color}</li>
            )}
            ...
            {character.skin_color && character.skin_color !== "n/a" && (
              <li className="mb-2">Color de piel: {character.skin_color}</li>
            )}
